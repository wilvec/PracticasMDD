 ...
 * <ul>
 *   <li>{@link de.vogella.emf.webpage.model.webpage.impl.MyWebImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.vogella.emf.webpage.model.webpage.impl.MyWebImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link de.vogella.emf.webpage.model.webpage.impl.MyWebImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link de.vogella.emf.webpage.model.webpage.impl.MyWebImpl#getKeywords <em>Keywords</em>}</li>
 *   <li>{@link de.vogella.emf.webpage.model.webpage.impl.MyWebImpl#getPages <em>Pages</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MyWebImpl extends EObjectImpl implements MyWeb {
	...
	public EList<WebPage> getPages() {
		if (pages == null) {
			pages = new EObjectContainmentEList<WebPage>(WebPage.class, this, WebpagePackage.MY_WEB__PAGES);
		}
		return pages;
	}
