...
public class CategoryItemProvider
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebpagePackage.Literals.CATEGORY__EREFERENCE0);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Category.class)) {
			case WebpagePackage.CATEGORY__NAME:
				...
				return;
			case WebpagePackage.CATEGORY__EREFERENCE0:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebpagePackage.Literals.CATEGORY__EREFERENCE0,
